...
export declare class JobScheduler extends QueueBase {
    ...
    upsertJobScheduler<T = any, R = any, N extends string = string>(jobSchedulerId: string, repeatOpts: Omit<RepeatOptions, 'key' | 'prevMillis' | 'offset'>, jobName: N, jobData: T, opts: JobSchedulerTemplateOptions, { override }: {
        override: boolean;
